...
| <a name="input_vpn_attachments"></a> [vpn\_attachments](#input\_vpn\_attachments) | Maps of maps of VPN details to attach to TGW. Type 'any' to disable type validation by Terraform. | `any` | `{}` | no |
